...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-[1] bg-gradient-to-r from-primary/50 via-primary/25 to-accent/20" />
      <div className="absolute inset-0 z-[2] bg-gradient-to-t from-background/50 via-transparent to-background/10" />
